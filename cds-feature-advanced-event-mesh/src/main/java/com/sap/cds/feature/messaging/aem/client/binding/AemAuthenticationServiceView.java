...
/**
 * AemAuthenticationServiceView provides a view of the authentication service credentials from a
 * given ServiceBinding.
 */
public class AemAuthenticationServiceView {
   ...
   *
   * @return {@code true} if the token endpoint, client ID, and client secret are present; {@code
   *     false} otherwise.
   */
  public boolean isTokenEndpointPresent() {
    return getTokenEndpoint().isPresent()
   ...
   *
   * @return an {@link Optional} containing the token endpoint URL if present, otherwise an empty
   *     {@link Optional}.
   */
   ...
   *
   * @return an {@link Optional} containing the client ID if present, otherwise an empty {@link
   *     Optional}
   */
   ...
   *
   * @return an {@link Optional} containing the client secret if present, otherwise an empty {@link
   *     Optional}
   */
